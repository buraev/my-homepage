...
export const Devices: NextPage = () => {
  return (
    <div className="mx-auto mt-24 flex max-h-full min-h-screen w-full max-w-prose flex-1 flex-col">
      <div className="flex flex-col gap-4 rounded-lg border border-secondaryMain p-3">
        <div>
              ...
              <div className="flex-2 flex flex-col gap-2">
                {[1, 2, 3, 4].map(el => {
                  return (
                    <div
                      key={el}
                      className="h-14 w-14 rounded-lg border border-dashed border-secondaryMain p-3"
                    >
                      {el}
                    </div>
                  )
